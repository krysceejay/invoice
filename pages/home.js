      ...
      <div>
        ...
        <div className="py-8">
          <div className="flex items-center space-x-3 px-4 md:px-8">
            ...
            <div>
              <h3 className="text-lg">Hello Chris,</h3>
          ...
          <div className="bg-black p-4 rounded-md mt-4 mx-4 md:mx-8">
            <h4 className="text-gray-200 text-base border-b border-gray-200 pb-2">
              Current Balance
            </h4>
            <div className="text-white flex items-baseline space-x-2 mt-6">
              <span className="text-sm">NGN</span>
              <span className="text-2xl">450,000.00</span>
            </div>
          </div>
          <div className="mt-6">
